...
export class SpringValue<T = any> extends FrameValue<T> {
        ...
        anim.values.forEach((node, i) => {
            ...
            if (!finished) {
                ...
                // Spring easing
                    ...
                    velocity =
                        node.lastVelocity == null ? v0 : node.lastVelocity
                    ...
                    for (let n = 0; n < numSteps; ++n) {
                        ...
                        const acceleration =
                            (springForce + dampingForce) / config.mass // pt/ms^2
    ...
    start(to?: T | SpringUpdate<T>, arg2?: SpringProps<T>) {
        ...
        return Promise.all(queue.map(props => this._update(props))).then(
...
>>>>>>> 9df86c469ffbd04fd3fbfb7b6b8827d8501d124d
}
