        ...
        (
            ...
            const ctrl = useMemoOne(() => {
                ...
                if (sticky) {
                    ...
                    const distance =
                        parent.space * offset + targetScroll * speed
                ...
                () => ({
                    ...
                    setPosition(height, scrollTop, immediate = false) {
                        if (sticky) {
                            ...
                            const distance =
                                height * offset + targetScroll * speed
                            ctrl.start({
    ...
    React.forwardRef<IParallax, ParallaxProps>((props, ref) => {
        ...
        const update = () => {
            ...
            if (enabled) {
                ...
                container[scrollType] = state.current =
                    state.offset * state.space
            }
